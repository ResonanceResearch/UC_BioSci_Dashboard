#!/usr/bin/env python3
"""
UC_BioSci_works.py — single-file OpenAlex ETL for BioSci dashboard
...
# Config
# ----------------------------
MAILTO = os.getenv("OPENALEX_MAILTO", "jeroen@labratdor.com")
...
def build_authorship_columns(df: pd.DataFrame) -> pd.DataFrame:
    ...
    def per_row(vals):
        if not isinstance(vals, list):
            # no authorships: return empty strings
            return ["", "", "", "", "", "", "", "", "", ""]
